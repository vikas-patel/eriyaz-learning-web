...
gulp.task('copy', function() {
  return gulp.src(['client/public/src/**/*.{html,jpg,gif,css,json,mp3,png,fnt,wav,m4a,ttf}', 'client/public/src/landing/**/*.js', 'client/public/src/signup/**/*.js', '!**/{ext-libs,dist}/**', '!**/{imports,index}.html'], {
