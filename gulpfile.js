...
gulp.task('copy', function() {
  return gulp.src(['client/public/src/**/*.{html,jpg,gif,css,json,mp3,lrc,png,fnt,wav,m4a,ttf,woff,eot,csv}', 'client/public/src/worker/*.js', '!**/{ext-libs,dist}/**', '!**/{imports,index}.html'], {
