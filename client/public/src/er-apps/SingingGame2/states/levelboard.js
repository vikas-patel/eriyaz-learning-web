define([], function () {
    ...
    Levels.prototype = {
      ...
      create: function() {
        ...
        var offsetY = 10 + (this.game.height - (this.thumbHeight+thumbSpacing)*thumbRows);
        var title = this.game.add.bitmapText(this.game.width/2, offsetY/2, 'flappyfont', 'Singing Game', 42);
