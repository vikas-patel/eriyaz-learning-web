define(['./level', '../prefabs/PipeGroup', '../prefabs/starGroup'], function (Parent, PipeGroup, StarGroup) {
	...
	Level.prototype.generatePipes = function() {
        ...
        this.y = 60;
        var random = this.game.rnd.integerInRange(3, 5);

        for (var i = 0; i < random; i++) {
            this.subPipeGenerator = this.game.time.events.add(Phaser.Timer.SECOND*1.6*i, this.generateSubPipes, this, this.y-180*(i%2));
